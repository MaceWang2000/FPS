...
@export_range(0.0, 0.2, 0.01) var sway_speed_position : float = 0.07
@export_range(0.0, 0.2, 0.01) var sway_speed_rotation : float = 0.1
@export_range(0.0, 0.25, 0.01) var sway_amount_position : float = 0.1
