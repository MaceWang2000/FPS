...
@onready var interaction_button: Sprite2D = $HBoxContainer/Container/InteractionButton
@onready var interaction_text: RichTextLabel = $HBoxContainer/InteractionText

func set_prompt(interaction_name:String, input_map_name:String) -> void:
